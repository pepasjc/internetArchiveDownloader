...
TRANSLATIONS = {
    'pt-BR': {
        ...
        # --- Interface nova (shell, filtros, detalhes, aparência) ---
        'app_subtitle': 'GERENCIADOR DE DOWNLOADS',
        'nav_downloads': 'Downloads',
        'nav_search': 'Buscar',
        'nav_item': 'Item',
        'nav_settings': 'Ajustes',
        'nav_theme': 'Tema',
        'nav_theme_tooltip': 'Alternar entre tema claro e escuro',

        'page_downloads_title': 'Downloads',
        'page_downloads_sub': 'Fila, progresso e conexões de cada arquivo',
        'page_search_sub': 'Procure itens no acervo do Internet Archive',
        'page_item_title': 'Arquivos do item',
        'page_item_sub': 'Liste e baixe arquivos de um identifier específico',
        'page_settings_sub': 'Conta, pastas, desempenho e aparência',

        'filter_all': 'Todos',
        'filter_active': 'Ativos',
        'filter_waiting': 'Na fila',
        'filter_paused': 'Pausados',
        'filter_completed': 'Concluídos',
        'filter_failed': 'Com falha',
        'downloads_filter_placeholder': 'Filtrar downloads por nome...',
        'downloads_empty': 'Nenhum download na fila. Use Buscar, Item ou arraste uma URL do archive.org para cá.',

        'dm_col_eta': 'Restante',
        'dm_col_added': 'Adicionado',

        'stat_active': 'Ativos',
        'stat_queued': 'Na fila',
        'stat_done': 'Concluídos',
        'stat_speed': 'Velocidade total',
        'stat_eta': 'Tempo restante',
        'speed_limit_label': 'Limite:',
        'speed_limit_tooltip': 'Teto global de velocidade em KB/s (0 = ilimitado)',
        'speed_unlimited': 'ilimitado',

        'detail_tab_info': 'Informações',
        'detail_tab_segments': 'Conexões',
        'detail_tab_graph': 'Velocidade',
        'detail_field_file': 'Arquivo',
        'detail_field_item': 'Item',
        'detail_field_folder': 'Pasta',
        'detail_field_url': 'URL',
        'detail_field_status': 'Status',
        'detail_field_size': 'Tamanho',
        'detail_field_speed': 'Velocidade',
        'detail_field_eta': 'Restante',
        'detail_field_added': 'Adicionado',
        'detail_field_completed': 'Concluído',
        'detail_field_id': 'ID',
        'detail_empty': 'Selecione um download para ver os detalhes.',
        'detail_toggle_show': 'Mostrar detalhes',
        'detail_toggle_hide': 'Ocultar detalhes',

        'appearance_section': '🎨 Aparência',
        'appearance_theme': 'Tema:',
        'appearance_theme_dark': 'Escuro',
        'appearance_theme_light': 'Claro',
        'appearance_accent': 'Cor de destaque:',
        'appearance_density': 'Densidade da lista:',
        'appearance_density_comfortable': 'Confortável',
        'appearance_density_compact': 'Compacta',
        'appearance_note': 'As mudanças de aparência são aplicadas na hora, sem reiniciar.',
        'accent_blue': 'Azul',
        ...
        'perf_speed_limit': 'Limite global de velocidade (KB/s, 0 = ilimitado):',
        'perf_speed_limit_tooltip': 'Aplica-se à soma de todos os downloads ativos',
        'tray_minimize': 'Minimizar para a bandeja ao fechar',
        'tray_tooltip_running': '{count} download(s) ativo(s) — {speed}',
        'tray_tooltip_idle': 'Nenhum download ativo',
        'tray_show': 'Mostrar janela',
        'tray_pause_all': 'Pausar tudo',
        'tray_resume_all': 'Retomar tudo',
        'tray_quit': 'Sair',
        'tray_completed': 'Download concluído',

        'action_pause_all': 'Pausar tudo',
        'action_resume_all': 'Retomar tudo',
        'action_open_folder': 'Abrir pasta',
        'action_details': 'Detalhes',
        'drop_hint': 'Solte URLs do archive.org para adicionar à fila',
        'dropped_added': '{count} URL(s) adicionada(s) à fila',
        'dropped_none': 'Nenhuma URL do archive.org encontrada no que foi solto',
    },
    ...
    'en': {
        ...
        # --- New shell: navigation, filters, detail pane, appearance ---
        'app_subtitle': 'DOWNLOAD MANAGER',
        'nav_downloads': 'Downloads',
        'nav_search': 'Search',
        'nav_item': 'Item',
        'nav_settings': 'Settings',
        'nav_theme': 'Theme',
        'nav_theme_tooltip': 'Switch between light and dark theme',

        'page_downloads_title': 'Downloads',
        'page_downloads_sub': 'Queue, progress and per-file connections',
        'page_search_sub': 'Find items across the Internet Archive',
        'page_item_title': 'Item files',
        'page_item_sub': 'List and download files from a specific identifier',
        'page_settings_sub': 'Account, folders, performance and appearance',

        'filter_all': 'All',
        'filter_active': 'Active',
        'filter_waiting': 'Queued',
        'filter_paused': 'Paused',
        'filter_completed': 'Completed',
        'filter_failed': 'Failed',
        'downloads_filter_placeholder': 'Filter downloads by name...',
        'downloads_empty': 'Queue is empty. Use Search, Item, or drop an archive.org URL here.',
        ...
        'stat_queued': 'Queued',
        'stat_done': 'Completed',
        'stat_speed': 'Total speed',
        'stat_eta': 'Time left',
        'speed_limit_label': 'Limit:',
        'speed_limit_tooltip': 'Global speed cap in KB/s (0 = unlimited)',
        'speed_unlimited': 'unlimited',

        'detail_tab_info': 'Info',
        'detail_tab_segments': 'Connections',
        'detail_tab_graph': 'Speed',
        'detail_field_file': 'File',
        'detail_field_item': 'Item',
        'detail_field_folder': 'Folder',
        'detail_field_url': 'URL',
        'detail_field_status': 'Status',
        'detail_field_size': 'Size',
        'detail_field_speed': 'Speed',
        'detail_field_eta': 'ETA',
        'detail_field_added': 'Added',
        'detail_field_completed': 'Completed',
        'detail_field_id': 'ID',
        'detail_empty': 'Select a download to see its details.',
        'detail_toggle_show': 'Show details',
        'detail_toggle_hide': 'Hide details',
        ...
        'appearance_density': 'List density:',
        'appearance_density_comfortable': 'Comfortable',
        'appearance_density_compact': 'Compact',
        'appearance_note': 'Appearance changes apply instantly — no restart needed.',
        'accent_blue': 'Blue',
        ...
        'perf_speed_limit': 'Global speed limit (KB/s, 0 = unlimited):',
        'perf_speed_limit_tooltip': 'Applies to the sum of all active downloads',
        'tray_minimize': 'Minimize to tray on close',
        'tray_tooltip_running': '{count} active download(s) — {speed}',
        'tray_tooltip_idle': 'No active downloads',
        'tray_show': 'Show window',
        'tray_pause_all': 'Pause all',
        'tray_resume_all': 'Resume all',
        'tray_quit': 'Quit',
        'tray_completed': 'Download completed',

        'action_pause_all': 'Pause all',
        'action_resume_all': 'Resume all',
        'action_open_folder': 'Open folder',
        'action_details': 'Details',
        'drop_hint': 'Drop archive.org URLs to add them to the queue',
        'dropped_added': '{count} URL(s) added to the queue',
        'dropped_none': 'No archive.org URL found in the dropped content',
    }
}
